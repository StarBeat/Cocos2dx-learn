...
{
public:
	static LightEffect* create(const std::string& fs, const std::string& vs = "");
	...
	void prepareForRender(cocos2d::Sprite* sprite, cocos2d::Texture2D* texture);
...
protected:
	bool init(const std::string& fs, const std::string& vs);
